      ...
      <PageHeader
        ...
        action={
          <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2">
            ...
            <Button size="sm" variant="outline" className="h-8 text-xs gap-1.5 w-full sm:w-auto">
          ...
          return (
            <Card key={item.label} className="p-3 sm:p-4">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                <div className={cn("size-8 sm:size-10 rounded-xl grid place-items-center shrink-0", tones[item.tone])}>
